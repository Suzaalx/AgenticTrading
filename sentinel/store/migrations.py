...
DDL_STATEMENTS: tuple[str, ...] = (
    ...
    """CREATE TABLE IF NOT EXISTS eval_results (bt_id TEXT PRIMARY KEY, experiment_id TEXT, pipeline TEXT,
                        symbol TEXT, config_json TEXT, spec_json TEXT, metrics_json TEXT,
                        equity_json TEXT, created_at TEXT)""",
